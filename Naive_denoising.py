...
if __name__ == '__main__':
	# Denoising_example = Naive_denoising(dimension_of_observation = 23, noise_variance = 0.01, show_observation = True, show_figure = True, save_figure = False)
	...
	# Sample_example.Set_Prior("TG", Lambda = 50, gamma = 0.1, d = 0.04)
	...
	# Sample_example = Naive_denoising(dimension_of_observation = 177, noise_variance = 0.001, show_observation = False, show_figure = True, save_figure = False)
	# Sample_example.Set_Prior("TV", Lambda = 50)
	# Sample_example.Metropolis_Hastings(sample_size = 1000, beta = 0.01)
	# Sample_example = Naive_denoising(dimension_of_observation = 353, noise_variance = 0.001, show_observation = False, show_figure = True, save_figure = False)
	# Sample_example.Set_Prior("TV", Lambda = 50)
	# Sample_example.Metropolis_Hastings(sample_size = 1000, beta = 0.01)
